CREATE OR REPLACE TRIGGER DQ_USER.TR_T_META_INTERFACE_AUD
AFTER INSERT OR UPDATE OR DELETE
ON DQ_USER.T_META_INTERFACE REFERENCING OLD AS OLD NEW AS NEW
FOR EACH ROW
BEGIN
  CASE
    WHEN INSERTING THEN
      INSERT INTO DQ_USER.T_META_INTERFACE_AUD
            (
             INTERFACE_ID
            ,TECHNOLOGY
            ,APTITUDE_PROJECT
