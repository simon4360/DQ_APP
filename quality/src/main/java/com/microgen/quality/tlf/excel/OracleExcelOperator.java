...
public class OracleExcelOperator implements IExcelOperator
{
    private static final Logger LOG = Logger.getLogger ( OracleExcelOperator.class );
    ...
    public OracleExcelOperator ( final IDatabaseConnector pIDatabaseConnector )
    {
    ...
    {
        LOG.info ( "Data will be loaded into the table '" + pTableOwner + "." + pExcelTabName + "', based on the excel file at '" + pPathToExcelFile + "'" );
        ...
        LOG.info ( "The width of the spreadsheet's tab was calculated to be '" + SPREADSHEET_WIDTH + "' cells" );
        ...
        LOG.info ( "Build an insert statement to target '" + pTableOwner + "." + pExcelTabName + "'" );
        ...
        try
        {
            ...
            else
            {
                ...
                for ( Row stRow : ST )
                {
                    LOG.info ( "Loading excel row # '" + stRow.getRowNum () + "'" );
