create or replace view g77_cfg.v_meta_batch_task_complete as 
select 
  i.aptitude_project 
...
from g77_cfg.t_meta_batch_task bt
join 
     g77_cfg.t_meta_interface i 
  on bt.interface_id = i.interface_id
left join 
     g77_cfg.t_meta_batch_task_table_x btx 
