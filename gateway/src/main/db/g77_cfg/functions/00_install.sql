...
--derived attributes
@@fn_da_bus_prtnr_grp_finc_sdl.sql
@@fn_da_bus_sgmt_prtnr_sdl.sql
@@fn_da_div_grp_finc_sdl.sql
@@fn_da_mgmnt_unt_grp_finc_sdl.sql
@@fn_da_prod_hub_sdl.sql
@@fn_da_typ_bus_grp_finc_sdl.sql
@@fn_da_typ_tty_grp_finc.sql
@@fn_da_uwrt_pf_sdl.sql