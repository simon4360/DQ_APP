create or replace FUNCTION G77_CFG.FN_DMP_ACTIVATE_DQ_RULE (json_data in clob)
  RETURN       NUMBER
IS
...
BEGIN
  ...
  LOOP
    UPDATE T_META_TABLE_DQ 
       SET DQ_ACTIVE_INDICATOR = 'A'
     WHERE DQ_CONFIG_ID        = data_param_row.DQ_CONFIG_ID 
       AND DQ_ACTIVE_INDICATOR = 'I';
