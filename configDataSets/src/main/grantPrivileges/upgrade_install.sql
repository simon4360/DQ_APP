...
-- ****************************
-- DO NOT REMOVE 
-- The below is re-runable and permanent part of the upgrade
-- ****************************
...
--Revoke and grant privileges g77_cfg_arc
...
BEGIN
PKG_MAINTENANCE_UTIL.P_REGISTER_G77_DB_INSTALL('@versionTo@', 'configDataSets/src/main/grantPrivileges/upgrade_install');
END;
/
