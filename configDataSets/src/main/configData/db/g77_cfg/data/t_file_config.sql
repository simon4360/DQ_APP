Delete from g77_cfg.t_file_config;

Insert Into  g77_cfg.t_file_config (file_id, use_case_id, source_system, file_name_pattern, file_path, header_footer,file_desc, tgt_charset)    
